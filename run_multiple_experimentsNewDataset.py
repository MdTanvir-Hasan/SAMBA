...
def main():
    ...
    parser.add_argument(
        "--dataset",
        type=str,
        default="mycreation/combined_dataframe_ASX200_raw_clean",
        # default="DJI",
        choices=[
            "mycreation/combined_dataframe_ASX200_raw_clean",
            "existingDataset/combined_dataframe_AAPL_raw_clean",
            "existingDataset/combined_dataframe_CNN_SP500_raw_clean",
        ],
        help="Dataset to use (mycreation/combined_dataframe_ASX200, existingDataset/combined_dataframe_AAPL, or existingDataset/combined_dataframe_CNN_SP500)",
    ...
    data_file = f"NewDataSet/{args.dataset}.csv"
